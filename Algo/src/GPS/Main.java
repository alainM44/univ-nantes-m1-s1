...
public class Main
{
	...
	public static String lireLettre(){//lecture d'un double
		String ligne_lue=lireString();
	...
	{	
		...
		if (Methode.compareTo("a")==0)
		{
			...
			monGPS.put_itineraire(	monGPS.BellmanFord(ponderation,villed,villea));
		...
		System.out.println("Temps de calcul de l'itinéraire: " + mili+" milli sec");
